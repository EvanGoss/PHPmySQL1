...
<body>
	<div id="container">
		...
		<div id="content"><!-- Start of the view birds page content. -->
			<div id="midcol">
				<h2>Bird Locations</h2>
				<p>
					<!--Add bird location table here-->
					<?php
						// Retrieve all records from birds table
						require('mysqli_connect.php');
						$q = "SELECT l.location, l.bird_id, b.bird_name, b.rarity, b.best_time FROM location l INNER JOIN birds b ON l.bird_id = b.bird_id";
